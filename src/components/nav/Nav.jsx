    ...
    <nav className="nav-container">
      ...
      <div >
            <div className="shortcut-links">
              <Link to="/" className="side-link" onClick={handleNav}>
                <MdOutlineDashboard className="icon" /> <span>Home</span>
              </Link>
              <Link to="/upload" className="side-link" onClick={handleNav}>
                <IoCloudUploadSharp className="icon" /> <span>Upload Video</span>
              </Link>
              <Link to="/firstupload" className="side-link" onClick={handleNav}>
                <FaRegSmile className="icon"/> <span>First Uploads</span>
              </Link>
              
              <Link to="/trend" className="side-link" onClick={handleNav}>
                <FaFire className="icon" /> <span>Trending Content</span>
              </Link> 
              <Link to="/new" className="side-link" onClick={handleNav}>
                <LuNewspaper className="icon" /> <span>New Content</span>
              </Link>
              <Link to="/communities" className="side-link" onClick={handleNav}>
                <MdOutlineDynamicFeed className="icon" /> <span>Communities</span>
              </Link>
              <div className="side-link" onClick={handleNav}>
